...
<body>
    ...
    <main class="relative z-10 font-athiti text-xl text-white flex flex-col items-center justify-center">
        ...
        <?php foreach ($galleries as $index => $item): ?>
            ...
            <div class="w-full max-w-screen-2xl mt-6 flex items-center justify-between gap-12 rounded-lg p-6 font-slackey <?= $index % 2 === 1 ? 'flex-row-reverse' : '' ?>">
                ...
                <div class="flex-1 <?= $index % 2 === 1 ? 'text-end' : '' ?>">
                    <h2 class="text-4xl mb-2"><?= $item['gallery_title'] ?></h2>
